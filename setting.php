                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <th scope="row"><?= $no ?></th>
                                                    <td><img src="<?php echo $row['urlgambar'] ?>" alt="" width="200px" height="200px"></td>
                                                    <td><?php echo $row['deskripsi'] ?></td>
                                                    <td><?php echo $row['urlgambar'] ?></td>
                                                    <td>
    ...
    <script>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'hapusgambar.php?id=' + id;
                }
            });
        }
    </script>
