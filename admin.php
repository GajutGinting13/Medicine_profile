          ...
          <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
              <ul class="sidebar-links" id="simple-bar">
                ...
                <li class="sidebar">
                  <!-- <a class="sidebar-link sidebar-title" href="admin.php"><i data-feather="home"></i><span class="lan-3">Dashboard </span></a> -->
                  <!-- <a class="sidebar-link sidebar-title" href="setting.php"><i data-feather="home"></i><span class="lan-3">Setting </span></a> -->
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php echo $row['nmPerusahaan'] ?></td>
                          ...
                          <td>
                            ...
                            <button class="btn btn-outline-warning" id="btn-edit" data-id="<?= $row['id'] ?>">Edit</button>
                          </td>
                        </tr>
                      <?php
                      }
            ...
            <div class="row g-3">
              ...
              <div class="col-md-4 mb-3">
                ...
                <div class="input-group">
                  ...
                  <input class="form-control" id="dp" type="text" aria-describedby="uangmuka" name="dp" required="">
                </div>
              </div>
            </div>
            <div class="row g-3">
  ...
  <script>
    $(document).ready(function() {
      $('#btn-edit').click(function() {
        ...
        const id = document.getElementById('idpelanggan').value = dataId;
        $.ajax({
          method: "GET",
          url: "ambildata.php?id=" + id,
          dataType: 'json',
          success: function(response) {
            $('#editModal').modal('show');
            document.getElementById('namapemesan').value = response.nama;
            document.getElementById('namaperusahaan').value = response.nmPerusahaan;
            document.getElementById('dp').value = response.dp;
            document.getElementById('alamat').value = response.alamat;
            document.getElementById('catatan').value = response.catatan;
            document.getElementById('paket').value = response.paket;
          }
        });
      })
